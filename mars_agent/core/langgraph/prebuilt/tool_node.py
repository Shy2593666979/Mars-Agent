...
from mars_agent.core.tools import BaseTool, InjectedToolArg
from mars_agent.core.tools import tool as create_tool
from mars_agent.core.tools.base import get_all_basemodel_annotations
from pydantic import BaseModel
from typing_extensions import Annotated, get_args, get_origin

from mars_agent.core.langgraph.errors import GraphBubbleUp
from mars_agent.core.langgraph.store.base import BaseStore
from mars_agent.core.langgraph.types import Command
...
def tools_condition(
    ...
    Examples:
        ...
        >>> from mars_agent.core.langgraph.prebuilt import ToolNode, tools_condition
...
class InjectedState(InjectedToolArg):
    ...
    Example:
        ...
        from mars_agent.core.langchain.messages import BaseMessage, AIMessage
        from mars_agent.core.tools import tool

        from mars_agent.core.langgraph.prebuilt import InjectedState, ToolNode
...
class InjectedStore(InjectedToolArg):
    ...
    Example:
        ...
        from mars_agent.core.langchain.messages import AIMessage
        from mars_agent.core.tools import tool

        from mars_agent.core.langgraph.store.memory import InMemoryStore
        from mars_agent.core.langgraph.prebuilt import InjectedStore, ToolNode
