...
from mars_agent.core.langgraph._api.deprecation import deprecated
...
class ToolExecutor(RunnableCallable):
    ...
    Examples:
        ...
        >>> from mars_agent.core.langgraph.prebuilt.tool_executor import ToolExecutor, ToolInvocation
        ...
        ...
        >>> @tool
