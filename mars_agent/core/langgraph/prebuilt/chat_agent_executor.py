...
from mars_agent.core.language_models import (
    BaseChatModel,
    LanguageModelInput,
    LanguageModelLike,
)
from mars_agent.core.langchain.messages import AIMessage, BaseMessage, SystemMessage, ToolMessage
from mars_agent.core.langchain.runnables import (
    Runnable,
    RunnableBinding,
    RunnableConfig,
)
from mars_agent.core.tools import BaseTool
from pydantic import BaseModel
from typing_extensions import Annotated, TypedDict

from mars_agent.core.langgraph.errors import ErrorCode, create_error_message
from mars_agent.core.langgraph.graph import END, StateGraph
from mars_agent.core.langgraph.graph.graph import CompiledGraph
from mars_agent.core.langgraph.graph.message import add_messages
from mars_agent.core.langgraph.managed import IsLastStep, RemainingSteps
from mars_agent.core.langgraph.prebuilt.tool_executor import ToolExecutor
from mars_agent.core.langgraph.prebuilt.tool_node import ToolNode
from mars_agent.core.langgraph.store.base import BaseStore
from mars_agent.core.langgraph.types import Checkpointer, Send
from mars_agent.core.langgraph.utils.runnable import RunnableCallable
...
def create_react_agent(
    ...
    *,
    ...
    Examples:
        ...
        >>> from mars_agent.core.langgraph.prebuilt import create_react_agent
        ...
        ```pycon
        >>> from mars_agent.core.prompts import ChatPromptTemplate
        ...
        >>>
        >>> from mars_agent.core.langgraph.managed import IsLastStep
        >>> prompt = ChatPromptTemplate.from_messages(
        ...     [
        ...
        ```pycon
        >>> from mars_agent.core.langgraph.prebuilt import InjectedStore
        >>> from mars_agent.core.langgraph.store.base import BaseStore
        ...
        >>> from mars_agent.core.langgraph.checkpoint.memory import MemorySaver
        >>> from mars_agent.core.langgraph.store.memory import InMemoryStore
        >>> store = InMemoryStore()
