...
from mars_agent.core.langchain.runnables.config import var_child_runnable_config

from mars_agent.core.langgraph.constants import CONF, CONFIG_KEY_STORE, CONFIG_KEY_STREAM_WRITER
...
def get_store() -> BaseStore:
    ...
    Example: Using with StateGraph
        ...
        from mars_agent.core.langgraph.config import get_store
...
def get_stream_writer() -> StreamWriter:
    ...
    Example: Using with StateGraph
        ...
        from typing_extensions import TypedDict
        from mars_agent.core.langgraph.graph import StateGraph, START
        from mars_agent.core.langgraph.config import get_stream_writer
