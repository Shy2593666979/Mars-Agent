...
from mars_agent.core.langgraph.graph.state import StateGraph
...
def add_messages(
    ...
    *,
    ...
    Examples:
        ```pycon
        >>> from mars_agent.core.langchain.messages import AIMessage, HumanMessage
        ...
        >>> from typing import Annotated
        >>> from typing_extensions import TypedDict
        >>> from mars_agent.core.langgraph.graph import StateGraph, add_messages
        >>>
        >>> class State(TypedDict):
...
class MessageGraph(StateGraph):
    ...
    Examples:
        ```pycon
        >>> from mars_agent.core.langgraph.graph.message import MessageGraph
        ...
        ...
        ```pycon
        >>> from mars_agent.core.langchain.messages import AIMessage, HumanMessage, ToolMessage
        >>> from mars_agent.core.langgraph.graph.message import MessageGraph
        ...
        >>> builder = MessageGraph()
        >>> builder.add_node(
...
def _format_messages(messages: Sequence[BaseMessage]) -> list[BaseMessage]:
    try:
        from mars_agent.core.langchain.messages import convert_to_openai_messages
    except ImportError:
        msg = (
