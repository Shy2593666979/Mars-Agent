...
if TYPE_CHECKING:
    from mars_agent.core.langsmith._internal._edit_distance import EditDistanceConfig
    from mars_agent.core.langsmith._internal._embedding_distance import EmbeddingConfig
...
class _Expect:
    ...
    def embedding_distance(
        ...
        *,
        ...
        Examples:
            ...
            ... ).to_be_less_than(1.0)
        """  # noqa: E501
        from mars_agent.core.langsmith._internal._embedding_distance import EmbeddingDistance
    ...
    def edit_distance(
        ...
        *,
        ...
        """
        from mars_agent.core.langsmith._internal._edit_distance import EditDistance
