...
from mars_agent.core.langsmith.utils import get_docker_compose_command
from mars_agent.core.langsmith.env._git import exec_git
...
def get_runtime_environment() -> dict:
    ...
    from mars_agent.core.langsmith import __version__
