...
from mars_agent.core.langsmith._internal._serde import dumps_json
from mars_agent.core.langsmith.client import ID_TYPE
...
def test(*args: Any, **kwargs: Any) -> Callable:
    ...
    Example:
        ...
        .. code-block:: python
            ...
            # from mars_agent.core.langsmith import test
            # @test
        ...
        .. code-block:: python
            ...
            import pytest
            from mars_agent.core.langsmith import traceable
        ...
        .. code-block:: python
            ...
            import openai
            import pytest
            from mars_agent.core.langsmith import wrappers
        ...
        .. code-block:: python
            ...
            import pytest
            from mars_agent.core.langsmith import expect
...
def log_inputs(inputs: dict, /) -> None:
    ...
    Example:
        .. code-block:: python
            ...
            from mars_agent.core.langsmith import testing as t
...
def log_reference_outputs(reference_outputs: dict, /) -> None:
    ...
    Example:
        .. code-block:: python
            ...
            from mars_agent.core.langsmith import testing
