...
from mars_agent.core.langsmith import run_trees, schemas
from mars_agent.core.langsmith import run_trees as rt
from mars_agent.core.langsmith import utils as ls_utils
from mars_agent.core.langsmith._internal import _aiter as aitertools
...
async def aevaluate(
    ...
    **kwargs: Any,
    ...
    Examples:
        ...
        >>> from mars_agent.core.langsmith import Client, aevaluate
...
async def aevaluate_existing(
    ...
    Examples:
        ...
        >>> from mars_agent.core.langsmith import aevaluate, aevaluate_existing
        >>> dataset_name = "Evaluate Examples"
        >>> async def apredict(inputs: dict) -> dict:
        ...     # This can be any async function or just an API call to your app.
        ...     await asyncio.sleep(0.1)
