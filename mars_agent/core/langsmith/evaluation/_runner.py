...
from mars_agent.core.langsmith import run_helpers as rh
...
from mars_agent.core.langsmith._internal._beta_decorator import _warn_once
...
from mars_agent.core.langsmith.evaluation.integrations import LangChainStringEvaluator
...
def evaluate(
    ...
    **kwargs: Any,
    ...
    Examples:
        ...
        >>> from mars_agent.core.langsmith.schemas import Example, Run
        >>> client = Client()
    ...
    if isinstance(target, (str, uuid.UUID, schemas.TracerSession)):
        ...
        msg = (
            ...
            "from mars_agent.core.langsmith import aevaluate\n\n"
            "await aevaluate(\n"
...
def evaluate_existing(
    ...
    Examples:
        >>> from mars_agent.core.langsmith.evaluation import evaluate, evaluate_existing
        >>> dataset_name = "Evaluate Examples"
        >>> def predict(inputs: dict) -> dict:
        ...     # This can be any function or just an API call to your app.
        ...     return {"output": "Yes"}
...
def evaluate_comparative(
    ...
    Examples:
        ...
        >>> import openai
        >>> from mars_agent.core.langsmith.evaluation import evaluate
        >>> from mars_agent.core.langsmith.wrappers import wrap_openai
        ...
        >>> import json
        >>> from mars_agent.core.langsmith.evaluation import evaluate_comparative
        >>> from mars_agent.core.langsmith import schemas
...
def _get_random_name() -> str:
    from mars_agent.core.langsmith.evaluation._name_generation import random_name  # noqa: F401
