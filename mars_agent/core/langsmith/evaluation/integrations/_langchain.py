...
from mars_agent.core.langsmith.evaluation.evaluator import DynamicRunEvaluator
...
class LangChainStringEvaluator:
    ...
    Examples:
        ...
        >>> from langchain_anthropic import ChatAnthropic
        >>> import langsmith
        >>> from mars_agent.core.langsmith.evaluation import LangChainStringEvaluator, evaluate
