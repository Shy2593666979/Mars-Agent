...
from mars_agent.core.langchain.load import dumpd, load
from mars_agent.core.langchain.vectorstores import VectorStore
from mars_agent.core.langchain.vectorstores.utils import _cosine_similarity as cosine_similarity
from mars_agent.core.langchain.vectorstores.utils import maximal_marginal_relevance

if TYPE_CHECKING:
    from collections.abc import Iterator, Sequence

    from mars_agent.core.langchain.embeddings import Embeddings
    from mars_agent.core.langchain.indexing import UpsertResponse
...
class InMemoryVectorStore(VectorStore):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from mars_agent.core.langchain.vectorstores import InMemoryVectorStore
