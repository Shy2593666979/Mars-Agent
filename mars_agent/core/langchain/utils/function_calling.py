...
from mars_agent.core.langchain._api import beta, deprecated
from mars_agent.core.langchain.messages import AIMessage, BaseMessage, HumanMessage, ToolMessage
from mars_agent.core.langchain.utils.json_schema import dereference_refs
from mars_agent.core.langchain.utils.pydantic import is_basemodel_subclass
...
def _convert_python_function_to_openai_function(
    ...
    """
    from mars_agent.core.langchain.tools.base import create_schema_from_function
...
def _format_tool_to_openai_function(tool: BaseTool) -> FunctionDescription:
    ...
    Returns:
        The function description.
    """
    from mars_agent.core.langchain.tools import simple
