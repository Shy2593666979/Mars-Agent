...
from mars_agent.core.langchain.example_selectors import BaseExampleSelector
...
class FewShotChatMessagePromptTemplate(
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.prompts import (
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.prompts import SemanticSimilarityExampleSelector
            from mars_agent.core.langchain.embeddings import OpenAIEmbeddings
            from mars_agent.core.langchain.vectorstores import Chroma
            ...
            from mars_agent.core.langchain import SystemMessage
            from mars_agent.core.langchain.prompts import HumanMessagePromptTemplate
            from mars_agent.core.langchain.prompts.few_shot import FewShotChatMessagePromptTemplate
            ...
            # Use within an LLM
            from mars_agent.core.langchain.chat_models import ChatAnthropic
