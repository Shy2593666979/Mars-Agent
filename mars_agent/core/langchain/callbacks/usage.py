...
from mars_agent.core.langchain._api import beta
...
from mars_agent.core.langchain.messages.ai import UsageMetadata, add_usage
from mars_agent.core.langchain.outputs import ChatGeneration, LLMResult
...
class UsageMetadataCallbackHandler(BaseCallbackHandler):
    ...
    Example:
        .. code-block:: python
            ...
            from mars_agent.core.langchain.callbacks import UsageMetadataCallbackHandler
...
def get_usage_metadata_callback(
    ...
    Example:
        .. code-block:: python
            ...
            from langchain.chat_models import init_chat_model
            from mars_agent.core.langchain.callbacks import get_usage_metadata_callback
    ...
    .. versionadded:: 0.3.49
    """
    from mars_agent.core.langchain.tracers.context import register_configure_hook
