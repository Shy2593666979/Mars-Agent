...
from mars_agent.core.langchain.messages import BaseMessage, get_buffer_string
from mars_agent.core.langchain.tracers.schemas import Run
from mars_agent.core.langchain.utils.env import env_var_is_set
...
if TYPE_CHECKING:
    ...
    from mars_agent.core.langchain.agents import AgentAction, AgentFinish
    from mars_agent.core.langchain.documents import Document
    from mars_agent.core.langchain.outputs import ChatGenerationChunk, GenerationChunk, LLMResult
    from mars_agent.core.langchain.runnables.config import RunnableConfig
...
def trace_as_chain_group(
    ...
    *,
    ...
    """  # noqa: E501
    from mars_agent.core.langchain.tracers.context import _get_trace_callbacks
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from mars_agent.core.langchain.callbacks.manager import CallbackManager, trace_as_chain_group
                from mars_agent.core.langchain.callbacks.stdout import StdOutCallbackHandler
    ...
    def merge(
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from mars_agent.core.langchain.callbacks.manager import CallbackManager, atrace_as_chain_group
                from mars_agent.core.langchain.callbacks.stdout import StdOutCallbackHandler
...
def _configure(
    ...
    *,
    ...
    """
    from mars_agent.core.langchain.tracers.context import (
        _configure_hooks,
        _get_tracer_project,
...
async def adispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnable import RunnableLambda
...
def dispatch_custom_event(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.callbacks import BaseCallbackHandler
            from mars_agent.core.langchain.callbacks import dispatch_custom_event
            from mars_agent.core.langchain.runnable import RunnableLambda
