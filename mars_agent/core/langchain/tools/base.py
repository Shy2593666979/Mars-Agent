...
from mars_agent.core.langchain.messages.tool import ToolCall, ToolMessage, ToolOutputMixin
...
from mars_agent.core.langchain.runnables.config import set_config_context
from mars_agent.core.langchain.runnables.utils import asyncio_accepts_context
from mars_agent.core.langchain.utils.function_calling import (
    _parse_google_docstring,
    _py_38_safe_origin,
)
from mars_agent.core.langchain.utils.pydantic import (
    TypeBaseModel,
...
class InjectedToolCallId(InjectedToolArg):
    ...
    Example:
        ..code-block:: python
            ...
            from mars_agent.core.langchain.messages import ToolMessage
            from mars_agent.core.langchain.tools import tool, InjectedToolCallID
