...
from mars_agent.core.langchain.runnables.base import Runnable, RunnableSerializable
...
from mars_agent.core.langchain.utils.aiter import py_anext

if TYPE_CHECKING:
    from mars_agent.core.langchain.callbacks.manager import AsyncCallbackManagerForChainRun
...
class RunnableWithFallbacks(RunnableSerializable[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.chat_models.openai import ChatOpenAI
            from mars_agent.core.langchain.chat_models.anthropic import ChatAnthropic
            ...
            from mars_agent.core.langchain.output_parser import StrOutputParser
