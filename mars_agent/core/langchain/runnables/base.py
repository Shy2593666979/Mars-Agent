...
from mars_agent.core.langchain._api import beta_decorator
from mars_agent.core.langchain.load.serializable import (
    Serializable,
...
from mars_agent.core.langchain.runnables.graph import Graph
...
from mars_agent.core.langchain.utils.aiter import aclosing, atee, py_anext
from mars_agent.core.langchain.utils.iter import safetee
from mars_agent.core.langchain.utils.pydantic import create_model_v2
...
if TYPE_CHECKING:
    ...
    from mars_agent.core.langchain.runnables.fallbacks import (
        RunnableWithFallbacks as RunnableWithFallbacksT,
    )
    from mars_agent.core.langchain.runnables.schema import StreamEvent
    from mars_agent.core.langchain.tools import BaseTool
    from mars_agent.core.langchain.tracers.log_stream import (
        RunLog,
        RunLogPatch,
    )
    from mars_agent.core.langchain.tracers.root_listeners import AsyncListener
...
class Runnable(Generic[Input, Output], ABC):
    ...
    **RunnableParallel** invokes runnables concurrently, providing the same input
    ...
    .. code-block:: python
        ...
        from mars_agent.core.langchain.runnables import RunnableLambda
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, list[str]]) -> RunnableSerializable[Any, Any]:
        ...
        Pick single key:
            .. code-block:: python
                ...
                from mars_agent.core.langchain.runnables import RunnableLambda, RunnableMap
        ...
        """
        from mars_agent.core.langchain.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.output_parsers import StrOutputParser
            from mars_agent.core.langchain.prompts import SystemMessagePromptTemplate
            from mars_agent.core.langchain.runnables import Runnable
            from operator import itemgetter
        ...
        """
        from mars_agent.core.langchain.runnables.passthrough import RunnableAssign
    ...
    async def astream_events(
        ...
        **ATTENTION** This reference table is for the V2 version of the schema.
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnables import RunnableLambda, RunnableConfig
            import asyncio
        ...
        """  # noqa: E501
        from mars_agent.core.langchain.tracers.event_stream import (
    ...
    def with_listeners(
        ...
        *,
        ...
        .. code-block:: python
            ...
            chain.invoke(2)
        """
        from mars_agent.core.langchain.tracers.root_listeners import RootListenersTracer
    ...
    def with_alisteners(
        ...
        *,
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnables import RunnableLambda, Runnable
        ...
        """
        from mars_agent.core.langchain.tracers.root_listeners import AsyncRootListenersTracer
    ...
    def with_retry(
        ...
        *,
        ...
        Returns:
            A new Runnable that retries the original Runnable on exceptions.
        """
        from mars_agent.core.langchain.runnables.retry import RunnableRetry
        ...
        *,
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from mars_agent.core.langchain.runnables import RunnableGenerator
    ...
    def _transform_stream_with_config(
        ...
        **kwargs: Optional[Any],
        ...
        from mars_agent.core.langchain.tracers._streaming import _StreamingCallbackHandler
    ...
    def as_tool(
        ...
        *,
        ...
        from mars_agent.core.langchain.tools import convert_runnable_to_tool
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnables import ConfigurableField
        ...
        """
        from mars_agent.core.langchain.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnables.utils import ConfigurableField
            from langchain_openai import ChatOpenAI
        ...
        """
        from mars_agent.core.langchain.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from mars_agent.core.langchain.runnables.passthrough import RunnableAssign, RunnablePick
    ...
    **RunnableSequence** is the most important composition operator in LangChain
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.output_parsers.json import SimpleJsonOutputParser
            from langchain_openai import ChatOpenAI
    ...
    def config_specs(self) -> list[ConfigurableFieldSpec]:
        ...
        """
        from mars_agent.core.langchain.beta.runnables.context import (
    ...
    def invoke(
        ...
        from mars_agent.core.langchain.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from mars_agent.core.langchain.beta.runnables.context import aconfig_with_context
    ...
    def batch(
        ...
        **kwargs: Optional[Any],
        ...
        from mars_agent.core.langchain.beta.runnables.context import config_with_context
        from mars_agent.core.langchain.callbacks.manager import CallbackManager
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        from mars_agent.core.langchain.beta.runnables.context import aconfig_with_context
        from mars_agent.core.langchain.callbacks.manager import AsyncCallbackManager
...
class RunnableParallel(RunnableSerializable[Input, dict[str, Any]]):
    ...
    we simultaneously stream output from two different Runnables:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.prompts import ChatPromptTemplate
            from mars_agent.core.langchain.runnables import RunnableParallel
            from langchain_openai import ChatOpenAI
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    context. Below we show an example:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.prompts import ChatPromptTemplate
            from mars_agent.core.langchain.runnables import RunnableGenerator, RunnableLambda
            from langchain_openai import ChatOpenAI
            from mars_agent.core.langchain.output_parsers import StrOutputParser
...
class RunnableEach(RunnableEachBase[Input, Output]):
    ...
    with a Runnable:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnables.base import RunnableEach
            from langchain_openai import ChatOpenAI
            from mars_agent.core.langchain.prompts import ChatPromptTemplate
            from mars_agent.core.langchain.output_parsers import StrOutputParser
...
class RunnableBinding(RunnableBindingBase[Input, Output]):
    ...
    `bind`: Bind kwargs to pass to the underlying Runnable when running it.
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.runnables import RunnableBinding
...
def chain(
    ...
    .. code-block:: python
        ...
        from mars_agent.core.langchain.runnables import chain
        from mars_agent.core.langchain.prompts import PromptTemplate
