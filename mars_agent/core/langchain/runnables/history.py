...
from mars_agent.core.langchain.chat_history import BaseChatMessageHistory
from mars_agent.core.langchain.load.load import load
from mars_agent.core.langchain.runnables.base import Runnable, RunnableBindingBase, RunnableLambda
from mars_agent.core.langchain.runnables.passthrough import RunnablePassthrough
...
if TYPE_CHECKING:
    from mars_agent.core.langchain.language_models.base import LanguageModelLike
    from mars_agent.core.langchain.messages.base import BaseMessage
...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    .. code-block:: python
        ...
        from mars_agent.core.langchain.prompts import ChatPromptTemplate, MessagesPlaceholder
    ...
    def _get_input_messages(
        ...
        if isinstance(input_val, str):
            from mars_agent.core.langchain.messages import HumanMessage
