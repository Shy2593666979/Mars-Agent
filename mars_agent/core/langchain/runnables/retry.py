...
from mars_agent.core.langchain.runnables.base import Input, Output, RunnableBindingBase
from mars_agent.core.langchain.runnables.config import RunnableConfig, patch_config
...
class RunnableRetry(RunnableBindingBase[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from mars_agent.core.langchain.chat_models import ChatOpenAI
