...
from mars_agent.core.langchain.load.serializable import Serializable, to_json_not_implemented
...
def _dump_pydantic_models(obj: Any) -> Any:
    ...
    from mars_agent.core.langchain.outputs import ChatGeneration
